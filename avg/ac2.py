...
logrd="/data4/home/gsoumyajit/avg/data/ac2/"
...
for n in range(N):
    ...
    value[state1]+=a(vstep[state1]//K+1)*(reward1+value[next_state1]*(next_state1!=state0)-value[state1]-lam)
    theta[state2,action2]-=b(pstep[state2,action2]//K+1)*(reward2+value[next_state2]*(next_state2!=state0)-value[state2]-lam)
